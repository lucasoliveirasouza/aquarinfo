...
class PeixeAguaSalgadaCadastroView extends StatefulWidget {
  const PeixeAguaSalgadaCadastroView({Key? key}) : super(key: key);

  @override
  State<PeixeAguaSalgadaCadastroView> createState() =>
      _PeixeAguaSalgadaCadastroViewState();
}

class _PeixeAguaSalgadaCadastroViewState
    extends State<PeixeAguaSalgadaCadastroView> {
