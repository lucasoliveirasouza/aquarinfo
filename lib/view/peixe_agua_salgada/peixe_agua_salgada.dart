...
import 'package:infoquario/view/peixe_agua_salgada/peixe_agua_salgada_cadastro.dart';
            ...
            CardItem(
              ...
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        PeixeAguaSalgadaListaView(tipo: "Todos"),
                  ),
                );
              },
            ),
            CardItem(
              ...
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        PeixeAguaSalgadaListaView(tipo: "Carnívoros"),
                  ),
                );
              },
            ),
            CardItem(
              ...
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        PeixeAguaSalgadaListaView(tipo: "Herbívoros"),
                  ),
                );
              },
            ),
            CardItem(
              ...
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        PeixeAguaSalgadaListaView(tipo: "Onívoros"),
                  ),
                );
              },
            ),
            CardItem(
              ...
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        PeixeAguaSalgadaListaView(tipo: "Planctógafos"),
                  ),
                );
              },
            ),
            CardItem(
              ...
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        PeixeAguaSalgadaListaView(tipo: "Detritívoros"),
                  ),
                );
              },
            ),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => PeixeAguaSalgadaCadastroView(),
            ),
          );
        },
      ),
