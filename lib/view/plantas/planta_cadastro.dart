...
class PlantaCadastroView extends StatefulWidget {
  const PlantaCadastroView({Key? key}) : super(key: key);

  @override
  _PlantaCadastroViewState createState() => _PlantaCadastroViewState();
}

class _PlantaCadastroViewState extends State<PlantaCadastroView> {
  ...
  final substrato = TextEditingController();
  ...
  String crescimento = 'Selecione o crescimento...';
  String iluminacao = 'Selecione a iluminação...';
          ...
          children: [
            ...
            Container(
              child: DropdownButtonFormField<String>(
                ...
                icon: Icon(null),
                elevation: 15,
                decoration: InputDecoration(labelText: 'Crescimento'),
                onChanged: (String? newValue) {
                  setState(() {
                    crescimento = newValue!;
                  });
                },
                items: <String>[
            ...
            Container(
              child: DropdownButtonFormField<String>(
                ...
                icon: Icon(null),
                elevation: 15,
                decoration: InputDecoration(labelText: 'Iluminação'),
                onChanged: (String? newValue) {
                  setState(() {
                    iluminacao = newValue!;
                  });
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  if (imagem == "" ||
                      ...
                      crescimento == 'Selecione o crescimento...' ||
                      iluminacao == 'Selecione a iluminação...'
                  ) {
