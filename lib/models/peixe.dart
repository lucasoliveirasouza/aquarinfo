...
class Peixe extends AnimalAquatico{
  ...
  Peixe(
      ...
      String dificuldade,
      String imagem
  ) : super(nomePopular, nomeCientifico, classe, ordem, familia, genero, origem, tipoAgua, tipo, tamanho, expectativa, populacaoMinima, tipoAquario, volumeMinimo, fachadaMinima, phAgua, temperatura, dificuldade, imagem);
